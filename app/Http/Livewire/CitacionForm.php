...
class CitacionForm extends Component
{
    public $carnet;
    ...
    public function mount()
    {
        ...
        Por medio de la presente el directorio del Sindicato CITA al directorio general de cada grupo mas hombres caracterizados al ampliado general que se llevara a cargo el dia 13 de septiembre del presente año a horas 09:00 a.m. en el salón de actos de nuestra institución con el siguiente orden del día.\n
        1. Control de asistencia \n
        2. Informe del Directorio\n
        3. Cambio de Sistema de Aportes";
    }
    ...
    public function generarPdf()
    {
        ...
        try {
            ...
            return redirect()->route('download-citacion');
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.citacion-form');
    }
}
