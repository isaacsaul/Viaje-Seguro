...
class MemoSuspensionLapsoForm extends Component
{
    public $carnet;
    ...
    public function mount()
    {
        ...
        El suscrito Secretario General suspende por 10 DÍAS, sujeto al artículo 75 del Estatuto Interno por NO PAGAR APORTES DE HOJA DE RUTA; el presente memorándum entra en vigencia a partir del día viernes 05 de marzo del presente año.\n
    ...
    public function generarPdf()
{
    ...
    try {
        ...
        $pdf = Pdf::loadView('pdf.memo-suspension-lapso', [
            'chofer' => $this->chofer,
        ...
        return redirect()->route('download-memo-suspension-lapso');
    } catch (\Exception $e) {
    ...
    {
        return view('livewire.memo-suspension-lapso-form');
    }
}
