...
class MemoAceptacionForm extends Component
{
    ...
    public function mount()
    {
        ...
        Tenemos a bien comunicarle que su solicitud de INGRESO como socio propietario del vehículo con placa ha sido aceptada EN FORMA DEFINITIVA. En consecuencia, a partir de la fecha se le autoriza a presentar servicios en las líneas de nuestro Sindicato.\n
        Por lo tanto, usted está comprometido al fiel cumplimiento respecto del Estatuto y del reglamento Interno que gobierna la Institución.";
    }
    ...
    public function generarPdf()
    {
        ...
        try {
            ...
            $pdf = Pdf::loadView('pdf.memo-aceptacion', [
                'chofer' => $this->chofer,
            ...
            return redirect()->route('download-memo-aceptacion');
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.memo-aceptacion-form');
    }
}
