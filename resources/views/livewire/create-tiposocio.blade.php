    ...
    <x-modal wire:model="open">
        <div class="rounded shadow-lg">
            ...
            <div class="bg-gray-200 py-4 px-6 rounded-t flex items-center justify-center">
                <slot name="title">Crear un nuevo tipo de socio</slot>
            </div>
            ...
            <div class="p-6">
                <slot name="content">
                    <div>
                        ...
                        <div class="w-full">
                            <input type="text" class="w-full rounded" wire:model.defer="nombresocio">
                            @error('nombresocio')
                    ...
                    <div>
                        ...
                        <div class="w-full" >
                            <textarea wire:model.defer="descripcionsocio" class="w-full" name="descripcion" rows="4"></textarea>
                            @error('descripcionsocio')
                               <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
