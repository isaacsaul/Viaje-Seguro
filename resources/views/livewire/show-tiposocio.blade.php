            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <table class="min-w-full divide-y divide-[#a4b0af]/20">
                    <thead class="bg-[#eff2f2]">
                        <tr>
                            <th scope="col" class="cursor-pointer px-6 py-4 text-left text-xs font-medium text-[#5d5c64] uppercase tracking-wider hover:text-[#28b0a3] transition-colors duration-300" wire:click="order('nombresocio')">
                                <div class="flex items-center gap-2">
                                    Nombre de Socio
                                    <i class="fas fa-sort"></i>
                                </div>
                            </th>
                            <th scope="col" class="cursor-pointer px-6 py-4 text-left text-xs font-medium text-[#5d5c64] uppercase tracking-wider hover:text-[#28b0a3] transition-colors duration-300" wire:click="order('descripcionsocio')">
                                <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            @if ($showDeleted)
                                                <button class="p-2 bg-[#28b0a3] text-white rounded-lg hover:bg-[#6acbc3] transition-all duration-300 shadow-sm hover:shadow-md transform hover:scale-[1.02]"
                                                    wire:click="restore({{ $tiposocio->id }})">
                                            ...
                                            @else
                                                <button class="p-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all duration-300 shadow-sm hover:shadow-md transform hover:scale-[1.02]"
                                                    wire:click="$emit('deleteTiposocio', {{$tiposocio->id}})">
