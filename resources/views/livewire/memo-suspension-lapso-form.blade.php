<div class="flex flex-col items-center">
    <div class="mb-4">
        <input type="text" wire:model.defer="carnet" placeholder="Ingrese el número de carnet"  class=" border border-gray-300 rounded" />
        <button wire:click="buscarChofer" class="p-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
            Memo Suspencion por Lapso
        </button>
    </div>

    @if($chofer)
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md w-full max-w-md">
        <h3 class="text-xl font-semibold mb-4 text-center">Memo Suspencion por Lapso</h3>
