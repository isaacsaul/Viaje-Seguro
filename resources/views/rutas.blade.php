            ...
            <div class="max-w-6xl mx-auto sm:px-2 lg:px-2">
                ...
                <div>
                     ...
                     <div class="bg-white" style="padding:10px ; margin-top:60px; border-radius: 10px;">
                            <h2 class="text-2xl font-semibold mb-4 text-center">Visualización de Rutas de Líneas en Google Maps</h2>
                            <!-- Puedes agregar cualquier otro contenido aquí -->
                            <h4 class="text-center"> Cada línea está representada por puntos que marcan las paradas principales a lo largo de la ruta, permitiendo a los usuarios visualizar claramente el trayecto de cada línea.</h4>
